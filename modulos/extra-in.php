  ...
  <div class="page-breadcrumb">
    <div class="row">
      <div class="col-12 d-flex no-block align-items-center">
        <h4 class="page-title">כניסה אקסטרס</h4>
        ...
        <form id="example-form" action="#" class="m-t-40">
          <div>
            ...
            <section>
              ...
              <label for="hour">שעה כניסה:</label>
              <div>
...
<script>
  ...
  function exchange() {
    const url = `https://pj-serverless.vercel.app/api/extras/zeut/${teudatzeut.value}`;
    fetch(url)
      .then((resp) => resp.json())
      .then(function(data) {
